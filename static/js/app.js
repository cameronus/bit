  ...
  $("form").submit(function(event) {
    ...
    $.ajax({
      ...
      swal({title: "<h1 class='mainTitle'>Bit created!</h1>",
            html: "<p class='regularText'>Click on this link to copy to clipboard <br>(not supported in Safari): <br><b><textarea id='selectLink' type='text' onclick='this.focus(); this.select(); document.execCommand(\"copy\")' readonly='readonly'>" + response + "</textarea></b></p>",
            type: "success"});
      $('#text').val('');
